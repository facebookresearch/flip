...
JOBNAME=flax/${name}_finetune/$(date +%Y%m%d_%H%M%S)_${VM_NAME}_${CONFIG}_${ep}ep_FT_b${batch}_lr${lr}_lrd${lrd}_${cls}_hinit${head_init}_b0.999_32mixup_NOcutmix_NOaa_NOerase_warmlr_NOencnorm_shf512b_fullevsp_seedNOshard
