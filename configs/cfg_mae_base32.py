...
def get_config():
  ...
  config.model.model_img.update(vit.get_b16_config())
  config.model.model_img.patches = ml_collections.ConfigDict({'size': (32, 32)})
