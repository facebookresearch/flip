...
#     load_params = flax.core.freeze(
#         state_load.pop("params")
#     )  # match the type of state.params
...
#         elif k in load_keys:
#             assert np.prod(named_state_params[k].shape) == np.prod(
#                 named_load_params[k].shape
#             ), "Not matching: {}, {}, {}".format(
#                 k, named_state_params[k].shape, named_load_params[k].shape
#             )
...
#                     )
#                 )
#                 named_load_params[k] = named_load_params[k].reshape(
#                     named_state_params[k].shape
#                 )
