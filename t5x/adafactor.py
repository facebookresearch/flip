...
class Adafactor(OptimizerDef):
  ...
  def init_state(self, params):
    params_flat = flatten_dict_string_keys(params)
    param_states_flat = [
  ...
  def apply_gradient(self, hyper_params, params, state, grads):
    ...
    params_flat_dict = flatten_dict_string_keys(params)
    ...
    states_flat = flatten_dict_string_keys(state.param_states)
    states_flat = [states_flat[k] for k in params_paths]
    grads_flat = flatten_dict_string_keys(grads)
  ...
  def set_param_axes(self, param_logical_axes):
    ...
    factor_map = flatten_dict_string_keys(factor_map)
